...
extension MealBolusNightscoutTreatment {
    ...
    public convenience init(carbEntry: StoredCarbEntry) {
       ...
       var myFoodType = carbEntry.foodType;
        ...
        self.init(timestamp: carbEntry.startDate, enteredBy: "loop://\(UIDevice.current.name)", id: carbEntry.externalID, carbs: lround(carbGrams), absorptionTime: carbEntry.absorptionTime, foodType: myFoodType
        )
